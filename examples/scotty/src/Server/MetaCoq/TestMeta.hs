...
-- next
deriving instance GQLType (List (Context_decl Term))
deriving  instance GQLType (List (Branch Term))

--GRep (deriveTypeValue, deriveTypeDefinition),

  
deriving  instance GQLType (List (Def Term)) 
deriving  instance GQLType (List Aname) 
deriving  instance GQLType (List Constructor_body) 
deriving  instance GQLType (List Elt1) 
deriving  instance GQLType Dirpath
deriving  instance GQLType (List One_inductive_body) 
deriving  instance GQLType (List Projection_body) 
deriving  instance GQLType (List T3) 
deriving  instance GQLType (List T36) 
deriving  instance GQLType (List Term) 
deriving  instance GQLType (Option (List T36)) 
deriving  instance GQLType OKername 
deriving  instance GQLType (Option Term)
deriving  instance GQLType (Context_decl Term) 
deriving  instance GQLType (Predicate Term)
deriving  instance GQLType (T25) 
deriving  instance GQLType (Prod Global_env Bool) 
deriving  instance GQLType (Prod Global_env Term)
deriving  instance GQLType (TGlobalDeclaration) 
deriving  instance GQLType Kername
deriving  instance GQLType  T35
deriving  instance GQLType (T14) 
deriving  instance GQLType T25S 
deriving  instance GQLType (List (TGlobalDeclaration))
